...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'To be able to use Znuny you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Voidaksesi käyttää Znuny-järjestelmää tulee sinun kirjoittaa seuraava komento root oikeuksilla komentokehotteessa.',
        'Restart your webserver' => 'Käynnistä web-palvelin uudestaan',
        'After doing so your Znuny is up and running.' => 'Tämän jälkeen Znuny järjestelmä on käytettävissä.',
        ...
        'Znuny Test Page' => 'Znuny - Testisivu',
        ...
        'Znuny as provider' => 'Znuny antaa tietoja',
        'Operations' => '',
        'Znuny as requester' => 'Znuny pyytää tietoja',
        'Invokers' => '',
