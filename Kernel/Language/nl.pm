...
sub Data {
    ...
    $Self->{Completeness}        = 0.476947535771065;
    ...
    $Self->{Translation} = {
        ...
        'A link to set a new password will be sent to your email address.' =>
            'Een link om een nieuw wachtwoord in te stellen wordt naar uw e-mailadres verzonden.',
        ...
        'Resend is not possible for this article!' => 'Opnieuw verzenden is niet mogelijk voor dit artikel!',
        ...
        'Your password reset link is invalid or has expired. Please request a new one.' =>
            'Uw link voor het resetten van het wachtwoord is ongeldig of verlopen. Vraag een nieuwe aan.',
        ...
        'Passwords do not match!' => 'Wachtwoorden komen niet overeen!',
        'Password does not match the requirements!' => 'Wachtwoord voldoet niet aan de vereisten!',
        'Password must be at least %s characters long!' => 'Wachtwoord moet minimaal %s tekens lang zijn!',
        'Password must contain at least 2 lowercase and 2 uppercase letter characters!' =>
            'Wachtwoord moet minimaal 2 kleine en 2 hoofdletters bevatten!',
        'Password must contain at least 1 digit!' => 'Wachtwoord moet minimaal 1 cijfer bevatten!',
        'Password must contain at least 2 letter characters!' => 'Wachtwoord moet minimaal 2 letters bevatten!',
        'Password changed. Please log in with your new password.' => 'Wachtwoord gewijzigd. Log in met uw nieuwe wachtwoord.',
        ...
        'Defines the validity period in seconds for password reset tokens. After this time the token expires and a new reset request is required. Default: 3600 (1 hour).' =>
            'Bepaalt de geldigheidsperiode in seconden voor tokens voor wachtwoordreset. Daarna verloopt het token en is een nieuw verzoek vereist. Standaard: 3600 (1 uur).',
        'Maximum number of password reset requests allowed per IP address or username within the rate limit window. Set to 0 to disable rate limiting. Default: 5.' =>
            'Maximaal aantal toegestane wachtwoordresetverzoeken per IP-adres of gebruikersnaam binnen het rate limiting-venster. Stel in op 0 om rate limiting uit te schakelen. Standaard: 5.',
        'Time window in seconds for password reset rate limiting. Attempts within this window are counted against the maximum. Default: 600 (10 minutes).' =>
            'Tijdsvenster in seconden voor rate limiting bij wachtwoordreset. Pogingen binnen dit venster tellen mee voor het maximum. Standaard: 600 (10 minuten).',
        ...
        'Defines the subject for notification mails sent to agents, confirming that the password has been reset.' =>
            'Bepaalt het onderwerp van notificatiemails aan agenten die de wachtwoordreset bevestigen.',
        'Defines the body text for notification mails sent to agents, confirming that the password has been reset.' =>
            'Bepaalt de tekst van notificatiemails aan agenten die de wachtwoordreset bevestigen.',
        ...
        'Defines the subject for notification mails sent to customers, confirming that the password has been reset.' =>
            'Bepaalt het onderwerp van notificatiemails aan klanten die de wachtwoordreset bevestigen.',
        'Defines the body text for notification mails sent to customers, confirming that the password has been reset.' =>
            'Bepaalt de tekst van notificatiemails aan klanten die de wachtwoordreset bevestigen.',
