...
sub Data {
    ...
    $Self->{Completeness}        = 0.193457789525855;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this Znuny system.' =>
            'Šiai Znuny sistemai bus sukurtas naujas, apribotas teises turintis, duomenų bazės naudotojas.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use Znuny you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Norėdami naudoti Znuny turite root naudotojo teisėmis, komandinėje eilutėje (terminale), įvesti šią komandą.',
        'Restart your webserver' => 'Perkraukite savo web serverį',
        'After doing so your Znuny is up and running.' => 'Atlikus šiuos veiksmus bus paleista Znuny sistema.',
        ...
        'Znuny Test Page' => 'Znuny Bandomasis puslapis',
        'Unlock' => 'Atrakinti',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitliukas',
