...
sub Data {
    ...
    $Self->{Completeness}        = 0.157706093189964;
    ...
    $Self->{Translation} = {
        ...
        'hours' => 'stundas',
        'Only business hours configured in System Config TimeWorkingHours are counted.' => 'Tiek uzskaitītas tikai darbalaika stundas.',
