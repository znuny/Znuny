...
sub Data {
    ...
    $Self->{Completeness}        = 0.283649212977835;
    ...
    $Self->{Translation} = {
        ...
        'Resend is not possible for this article!' => 'Повторното испраќање не е можно за овој член!',
...
' => '',
        ...
        'New process ticket' => '',
        'News' => '',
        'News about OTRS releases!' => 'Вести во врска со OTRS изданија!',
        'No public key found.' => '',
