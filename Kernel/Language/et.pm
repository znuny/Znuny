...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Install Type' => '',
        'Create a new database for Znuny' => 'Loo OTRSile uus andmebaas',
        'Use an existing database for Znuny' => 'Kasuta olemasolevat andmebaasi',
        ...
        'To be able to use Znuny you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Znuny kasutamiseks peate järgneva käsu sisestama süsteemi root-kasutajana.',
        'Restart your webserver' => 'Taaskäivita veebiserver.',
        'After doing so your Znuny is up and running.' => 'Peale seda Znuny töötab.',
        ...
        'Znuny Test Page' => 'Znuny testileht',
        'Unlock' => 'Eemalda lukk',
        'Welcome %s %s' => '',
        'Counter' => 'Loendur',
