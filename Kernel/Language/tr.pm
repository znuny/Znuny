...
sub Data {
    ...
    $Self->{Completeness}        = 0.183380142078308;
    ...
    $Self->{Translation} = {
        ...
        'After doing so your Znuny is up and running.' => 'Bunu yaptıktan sonra Znuny çalışıyor olacak.',
        ...
        'Znuny Test Page' => 'Znuny Test Sayfası',
        'Unlock' => 'Kilidi Aç',
        'Welcome %s %s' => '',
        'Counter' => 'Sayaç',
