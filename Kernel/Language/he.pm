...
sub Data {
    ...
    $Self->{Completeness}        = 0.224021146538906;
...
הקבצים צריכים להיות בפורמט yml. אשר ייצאו דרך מודול  ACL editor.',
        ...
        'After doing so your Znuny is up and running.' => 'לאחר שמערכת Znuny תותקן.',
        ...
        'Znuny Test Page' => 'עמוד בדיקה Znuny',
        'Unlock' => 'שחרר נעילה',
        'Welcome %s %s' => '',
        'Counter' => 'מונה',
        ...
        'Znuny as provider' => 'Znuny כמספק',
        'Operations' => '',
        'Znuny as requester' => 'Znuny כמבקש',
        'Invokers' => '',
