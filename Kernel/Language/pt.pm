...
sub Data {
    ...
    $Self->{Completeness}        = 0.308243727598566;
    ...
    $Self->{Translation} = {
        ...
        'hours' => 'horas',
        'Only business hours configured in System Config TimeWorkingHours are counted.' => 'Apenas são contabilizadas horas de expediente',
