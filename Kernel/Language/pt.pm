...
sub Data {
    ...
    $Self->{Completeness}        = 0.302762608416319;
    ...
    $Self->{Translation} = {
        ...
        'Remove closed tickets from agents\' ticket watch lists.' => 'Remover tickets fechados das listas de tickets vigiados dos agentes.',
