...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Error fetching mail%s, please check the Communication Log!' => 'Error al traer correos%s, ¡por favor consulte el registro de comunicaciones!',
        ...
        'Resend is not possible for this article!' => '¡No es posible reenviar este artículo!',
...
El control del acceso adicional para demostrar o no demostrar éste enlace puede ser hecha por usar el "Grupo" Clave y el Contenido como "rw:group1;move_into:group2". ',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event.' =>
            'Configura un ajuste por defecto de CampoDinamicoTicket. "Nombre" define el campo dinámico que debe ser usado, "Valor" es el dato que será establecido, y "Evento" define el disparador del evento.',
