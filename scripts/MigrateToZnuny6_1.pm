...
package scripts::MigrateToZnuny6_1;    ## no critic
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $MigrateToZnunyObject = $Kernel::OM->Get('scripts::MigrateToZnuny6_1');
...
sub _ExecuteComponent {
    ...
    for my $Task (@Tasks) {
        ...
        my $ModuleName = "scripts::MigrateToZnuny6_1::$Task->{Module}";
        ...
        $Kernel::OM->ObjectParamAdd(
            "scripts::MigrateToZnuny6_1::$Task->{Module}" => {
                Opts => $Self->{Opts},
            },
        );
