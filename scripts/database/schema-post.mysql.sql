...
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'activity' AND constraint_name = 'FK_activity_user_id_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE activity ADD CONSTRAINT FK_activity_user_id_id FOREIGN KEY (user_id) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_activity_user_id_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'activity' AND constraint_name = 'FK_activity_create_by_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE activity ADD CONSTRAINT FK_activity_create_by_id FOREIGN KEY (create_by) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_activity_create_by_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
...
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'sendmail_config' AND constraint_name = 'FK_sendmail_config_oauth2_token_config_id_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE sendmail_config ADD CONSTRAINT FK_sendmail_config_oauth2_token_config_id_id FOREIGN KEY (oauth2_token_config_id) REFERENCES oauth2_token_config (id)', 'SELECT ''INFO: Foreign key constraint FK_sendmail_config_oauth2_token_config_id_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'sendmail_config' AND constraint_name = 'FK_sendmail_config_create_by_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE sendmail_config ADD CONSTRAINT FK_sendmail_config_create_by_id FOREIGN KEY (create_by) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_sendmail_config_create_by_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'sendmail_config' AND constraint_name = 'FK_sendmail_config_change_by_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE sendmail_config ADD CONSTRAINT FK_sendmail_config_change_by_id FOREIGN KEY (change_by) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_sendmail_config_change_by_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'sendmail_config' AND constraint_name = 'FK_sendmail_config_valid_id_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE sendmail_config ADD CONSTRAINT FK_sendmail_config_valid_id_id FOREIGN KEY (valid_id) REFERENCES valid (id)', 'SELECT ''INFO: Foreign key constraint FK_sendmail_config_valid_id_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
...
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'translation' AND constraint_name = 'FK_translation_create_by_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE translation ADD CONSTRAINT FK_translation_create_by_id FOREIGN KEY (create_by) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_translation_create_by_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'translation' AND constraint_name = 'FK_translation_change_by_id');
SET @FKSQLStatement := IF( @FKExists = 0, 'ALTER TABLE translation ADD CONSTRAINT FK_translation_change_by_id FOREIGN KEY (change_by) REFERENCES users (id)', 'SELECT ''INFO: Foreign key constraint FK_translation_change_by_id does already exist, skipping.''' );
PREPARE FKStatement FROM @FKSQLStatement;
EXECUTE FKStatement;
SET @FKExists := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'translation' AND constraint_name = 'FK_translation_valid_id_id');
