...
my @Tests = (
    {
        Name            => 'ITSM 6.1.1 to 6.1.20',
        InstallPackages => [
            'TestGeneralCatalog-6.1.1.opm',
            'TestImportExport-6.1.1.opm',
            'TestITSMCore-6.1.1.opm',
            'TestITSMChangeManagement-6.1.1.opm',
            'TestITSMConfigurationManagement-6.1.1.opm',
            'TestITSMIncidentProblemManagement-6.1.1.opm',
            'TestITSMServiceLevelManagement-6.1.1.opm',
        ],
        RepositoryListBefore => {
            TestGeneralCatalog                => '6.1.1',
            TestImportExport                  => '6.1.1',
            TestITSMCore                      => '6.1.1',
            TestITSMIncidentProblemManagement => '6.1.1',
            TestITSMConfigurationManagement   => '6.1.1',
            TestITSMChangeManagement          => '6.1.1',
            TestITSMServiceLevelManagement    => '6.1.1',
        },
        PackageOnlineList => 'PackageOnlineListITSM6120.asc',
        ExpectedResult    => {
            Success        => 1,
            AlreadyUpdated => {},
            Failed         => {},
        ...
        RepositoryListAfter => {
            TestGeneralCatalog                => '6.1.20',
            TestImportExport                  => '6.1.20',
            TestITSMCore                      => '6.1.20',
            TestITSMIncidentProblemManagement => '6.1.20',
            TestITSMConfigurationManagement   => '6.1.20',
            TestITSMChangeManagement          => '6.1.20',
            TestITSMServiceLevelManagement    => '6.1.20',
        },
    },
    {
        Name            => 'ITSM 6.1.1 to 6.1.20 (New dependencies)',
        InstallPackages => [
            'TestImportExport-6.1.1.opm',
            'TestITSMChangeManagement-NoDep-6.1.1.opm',
            'TestITSMConfigurationManagement-NoDep-6.1.1.opm',
            'TestITSMIncidentProblemManagement-NoDep-6.1.1.opm',
            'TestITSMServiceLevelManagement-NoDep-6.1.1.opm',
        ],
        RepositoryListBefore => {
            TestImportExport                  => '6.1.1',
            TestITSMIncidentProblemManagement => '6.1.1',
    ...
    {
        Name            => 'ITSM 6.1.1 to 6.1.20 (Missing dependencies)',
        InstallPackages => [
            'TestGeneralCatalog-6.1.1.opm',
            'TestImportExport-6.1.1.opm',
            'TestITSMCore-6.1.1.opm',
        ...
        PackageOnlineList => 'PackageOnlineListITSM6120MissingITSMCore.asc',
        ExpectedResult    => {
            Success        => 0,
            AlreadyUpdated => {},
            Failed         => {
