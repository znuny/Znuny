...
package scripts::MigrateToZnuny6_1::UpgradeDatabaseStructure;    ## no critic
...
#         },
    ...
    for my $Task (@Tasks) {
        ...
        my $ModuleName = "scripts::MigrateToZnuny6_1::UpgradeDatabaseStructure::$Task->{Module}";
        ...
        $Kernel::OM->ObjectParamAdd(
            "scripts::MigrateToZnuny6_1::UpgradeDatabaseStructure::$Task->{Module}" => {
