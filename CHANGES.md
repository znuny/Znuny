# 6.5.2 ????-??-???
 - 2023-04-24 Added parameter Ticket::Frontend::HideMessageFromCustomerByDefaultIfSourceMessageHidden to hide messages by default from customer if source message is hidden.
