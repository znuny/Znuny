CodeMirror.defineMode("bbcode",function(a){var c,f="b i u s img quote code list table  tr td size color url",k="* :-) hr cut";a.hasOwnProperty("bbCodeTags")&&(f=a.bbCodeTags);a.hasOwnProperty("bbCodeUnaryTags")&&(k=a.bbCodeUnaryTags);a=function(b){return b.replace(/([\:\-\)\(\*\+\?\[\]])/g,"\\$1")};var h=/[a-zA-Z0-9_]/,l=/['"]/,m=new RegExp("(?:"+a(f).split(" ").join("|")+")"),n=new RegExp("(?:"+a(k).split(" ").join("|")+")"),g={tokenizer:function(b,d){if(!b.eatSpace()){if(b.match("[",!0))return d.tokenize=
g.bbcode,c="startTag","tag";b.next()}return null},inAttribute:function(b){return function(d,c){for(var a,e=null;!d.eol();){if(a=d.peek(),d.next()==b&&"\\"!==e){c.tokenize=g.bbcode;break}e=a}return"string"}},bbcode:function(b,d){if(b.match("]",!0))return d.tokenize=g.tokenizer,c=null,"tag";if(b.match("[",!0))return c="startTag","tag";var a=b.next();if(l.test(a))return d.tokenize=g.inAttribute(a),c="string","string";if(/\d/.test(a))return b.eatWhile(/\d/),c="number","number";if("whitespace"==d.last)return b.eatWhile(h),
