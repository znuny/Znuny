...
/**
 * @namespace
 * @exports TargetNS as Core.Customer.TicketProcessCategory
 * @description
 *      This namespace contains the special functions for TicketProcessCategory.
 */
Core.Customer.TicketProcessCategory = (function (TargetNS) {

    /**
    * @private
    * @name Init
    * @memberof Core.Customer.TicketProcessCategory
    * @function
    * @description
...
}(Core.Customer.TicketProcessCategory || {}));
